...
import com.example.demo.Specifications.MessagesSpecification;
...
public class MessagesService {
    ...
    public List<Messages> getMessagesByFilter(MessagesFilter messagesFilter){
        return messagesRepository.findAll(MessagesSpecification.filter(messagesFilter));
    }
}
